...
$phrases = @{
    ...
    "before_start_to_the_line_completed"   = "Before start checklist completed to the line "
    ...
    "briefing"                             = "Briefing"
    "climb_to_the_line_completed"          = "After takeoff climb checklist completed to the line"
